...
const STATIC_META: Record<string, PageMeta> = {
  ...
  '/campaigns': {
    title: 'Форматы рекламных кампаний и бюджеты — Медиа 2.7',
    description:
      'Тест нового предложения, запуск и рост, продвижение на квартал. Состав работ, сроки, отчётность и ориентиры бюджета для бизнеса на Дальнем Востоке.',
  },
  '/formats': {
