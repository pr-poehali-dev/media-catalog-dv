...
export const COMMUNITIES: Community[] = [
  ...
  // MAX
  {
    ...
    reachSummary: ['2 тыс.'],
    socials: [{ social: 'max', subscribers: 2750, reachLabel: '2 тыс.', engagementLabel: '1,1%', link: 'https://max.ru/dalha_b' }],
    formats: POST_FORMATS,
    bestFor: [],
    prices: [
      {
  ...
  },
  {
    ...
    subscribersTotal: '',
    reachSummary: [''],
    socials: [{ social: 'max', subscribers: 0, reachLabel: '', link: 'https://max.ru/hardkorushka_25' }],
    formats: POST_FORMATS,
    bestFor: [],
