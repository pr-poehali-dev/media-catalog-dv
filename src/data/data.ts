...
export const BLOGGERS: Blogger[] = [
  {
    ...
    description: 'Концепт городского женского журнала, где собраны новости о звёздах и событиях Хабаровска, обзоры мест и бьюти-советы, темы для мам и повседневная жизнь города.',
