...
export const FAQ_DATA: FAQ[] = [
  {
    ...
    answer: 'Стоимость зависит от площадки, города и формата. Минимальный бюджет — от 1 200 рублей за один пост. Пакетные размещения обходятся дешевле. Напишите нам — подберём варианты под ваш бюджет.',
  },
  {
    question: 'Можно ли подобрать площадки под конкретный бюджет?',
    answer: 'Да. Мы составим медиаплан с подбором площадок, форматов и расписанием размещений под ваш бюджет. Это бесплатно — просто заполните заявку или напишите в Telegram.',
  },
  {
    question: 'Кто пишет рекламный текст?',
    answer: 'Вы можете предоставить готовый материал или мы напишем текст и согласуем с вами. Также помогаем с рекомендациями по визуалу и структуре поста.',
  },
  {
  ...
  {
    question: 'Какую соцсеть выбрать для своего бизнеса?',
    answer: 'Зависит от аудитории и задачи. ВКонтакте — для широкого локального охвата, Telegram — для скорости и доверия, Одноклассники — для взрослой аудитории, TikTok — для молодёжи и видеоконтента. Поможем выбрать на консультации.',
  },
  {
...
export const WORK_STEPS = [
  { step: 1, emoji: '📝', title: 'Заявка', desc: 'Вы оставляете заявку или пишете в Telegram. Мы отвечаем в течение 2 часов.' },
  { step: 2, emoji: '📋', title: 'Бриф', desc: 'Уточняем задачу: цель, аудитория, бюджет, сроки, город и соцсеть.' },
  { step: 3, emoji: '🔍', title: 'Подбор площадок', desc: 'Формируем медиаплан с конкретными площадками, охватами и ценами.' },
  { step: 4, emoji: '✅', title: 'Согласование', desc: 'Вы утверждаете медиаплан и рекламный материал. Вносим правки.' },
  { step: 5, emoji: '🚀', title: 'Размещение', desc: 'Публикуем в согласованное время. Вы получаете подтверждение.' },
  { step: 6, emoji: '📊', title: 'Отчёт', desc: 'Предоставляем скриншоты статистики и итоги кампании.' },
];
...
export const MERCH_ITEMS: MerchItem[] = [
  {
    ...
    description: 'Фирменная посуда с логотипом — ежедневный контакт с брендом дома и в офисе.',
    why: 'Используется каждый день. На виду у хозяина и его гостей.',
    priceFrom: 350,
    emoji: '☕',
  },
  {
    ...
    description: 'Носимая реклама. Клиент становится амбассадором бренда.',
    why: 'Ходячая реклама — бренд видят все вокруг носителя.',
    priceFrom: 500,
    emoji: '👕',
  },
  {
    ...
    description: 'Экологичный и модный мерч. Используется на рынке, в магазине, на прогулке.',
    why: 'Высокая частота контакта. Тренд на экологичность работает в пользу бренда.',
    priceFrom: 200,
    emoji: '🛍️',
  },
  {
    ...
    description: 'Статусный корпоративный подарок. Остаётся на столе клиента.',
    why: 'Всегда на рабочем столе — бренд перед глазами весь рабочий день.',
    priceFrom: 300,
    emoji: '📓',
  },
  {
    ...
    description: 'Самый массовый и доступный мерч. Ручки часто уходят дальше — к коллегам и знакомым.',
    why: 'Расходный материал, который распространяется сам собой.',
    priceFrom: 30,
    emoji: '🖊️',
  },
  {
    ...
    description: 'Небольшой, но запоминающийся сувенир. Носится на ключах, рюкзаке, одежде.',
    why: 'Долговечно. На виду каждый раз, когда клиент берёт ключи.',
    priceFrom: 80,
    emoji: '🔑',
  },
  {
    ...
    description: 'Практичный и ценный подарок. Используется регулярно.',
    why: 'Высокая воспринимаемая ценность подарка. Технологичный имидж бренда.',
    priceFrom: 1200,
    emoji: '🔋',
  },
  {
