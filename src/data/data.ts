...
export const BLOGGERS: Blogger[] = [
  ...
  },
  {
    ...
    social: 'instagram',
    city: 'Хабаровск',
    category: 'Новостное и городское сообщество',
    description: 'Новостное городское сообщество о Хабаровске и Дальнем Востоке: федеральные и региональные новости, городская повестка и видео от ведущего.',
    fullDescription: 'Хабаровск Дальний Восток — новостное и городское сообщество о событиях Хабаровска, региона и Дальнего Востока. Публикует федеральные и региональные новости, городскую повестку, видео от ведущего, Reels, фотопосты, карусели и сторис.',
    subscribersTotal: '137,2 тыс.',
    reachSummary: [
      'до 46,5 тыс. охвата на пост в Instagram*',
      'до 9,7 тыс. охвата на пост в MAX',
    ],
    ...
    formats: ['Reels', 'Фотопост', 'Карусель', 'Сторис', 'Видео', 'Новость в ленте', 'Новость в ленте + сторис'],
    formatsByPlatform: [
    ...
    bestFor: ['Мероприятиям', 'Застройщикам и недвижимости', 'Городским акциям', 'Магазинам одежды', 'Региональным проектам', 'Брендам с охватом по ДВ'],
    prices: [
