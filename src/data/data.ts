...
export const COMMUNITIES: Community[] = [
  ...
  // Telegram
  {
    ...
    bestFor: [],
    prices: [
      { label: 'Пост в ленту', price: '2 000 ₽' },
      { label: 'Закреп на 3 дня', price: '+ 500 ₽' },
    ],
    priceFromLabel: 'от 2 000 ₽',
    emoji: '✈️',
  ...
  },
  {
    ...
    subscribersTotal: '',
    reachSummary: [''],
    socials: [{ social: 'telegram', subscribers: 0, reachLabel: '', link: 'https://t.me/+7P9ogfHgHLs1Zjhi' }],
    formats: POST_FORMATS,
    bestFor: [],
    prices: postPrice(1900),
    priceFromLabel: 'от 1 900 ₽',
    emoji: '🚨',
