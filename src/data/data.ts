...
export const COMMUNITIES: Community[] = [
  ...
  },
  {
    ...
    subscribersTotal: '53,5 тыс.',
    reachSummary: ['1 тыс.'],
    socials: [
      { social: 'vk', subscribers: 53484, reachLabel: '1 тыс.', engagementLabel: '9,4%', link: 'https://vk.ru/my_day27' },
    ],
    audienceCharts: {
      gender: [
  ...
  // MAX
  {
    ...
    subscribersTotal: '2,75 тыс.',
    reachSummary: ['2,5 тыс.'],
    socials: [{ social: 'max', subscribers: 2750, reachLabel: '2,5 тыс.', engagementLabel: '1,1%', link: 'https://max.ru/dalha_b' }],
    formats: POST_FORMATS,
    bestFor: [],
    prices: [
      {
