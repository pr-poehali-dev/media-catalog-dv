...
export const COMMUNITIES: Community[] = [
  ...
  },
  {
    ...
    fullDescription: 'Новости о самом главном и самом значимом в Приморье и мире.\n\nЗдесь всегда есть что посмотреть: интервью, обзоры, репортажи и спецпроекты. А ещё мы умеем шутить и делать мемы.',
  ...
  },
  {
    ...
    subscribersTotal: '',
    reachSummary: [''],
    socials: [{ social: 'vk', subscribers: 0, reachLabel: '', link: 'https://vk.ru/khabtv' }],
