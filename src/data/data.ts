...
export const COMMUNITIES: Community[] = [
  ...
  // Telegram
  {
    ...
    subscribersTotal: '',
    reachSummary: [''],
    socials: [{ social: 'telegram', subscribers: 0, reachLabel: '', link: 'https://t.me/+Mp2ybfws6HM5MjZi' }],
  ...
  },
  {
    ...
    subscribersTotal: '',
    reachSummary: [''],
    socials: [{ social: 'telegram', subscribers: 0, reachLabel: '', link: 'https://t.me/+oTngg60Wt8g5ZWFi' }],
    formats: POST_FORMATS,
    bestFor: [],
    prices: postPrice(200),
    priceFromLabel: 'от 200 ₽',
    emoji: '🏛️',
    link: 'https://t.me/+oTngg60Wt8g5ZWFi',
  },
  ...
  // MAX
  {
    ...
    subscribersTotal: '',
    reachSummary: [''],
    socials: [{ social: 'max', subscribers: 0, reachLabel: '', link: 'https://max.ru/zarodynu' }],
    formats: POST_FORMATS,
    bestFor: [],
    prices: postPrice(1250),
    priceFromLabel: 'от 1 250 ₽',
    emoji: '🏙️',
    link: 'https://max.ru/zarodynu',
  },
  {
    id: 'max-khv-dv',
    name: 'Хабаровск | Дальний Восток',
