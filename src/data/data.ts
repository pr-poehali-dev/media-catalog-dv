...
export const OUTDOOR_FORMATS: OutdoorFormat[] = [
  {
    ...
    fits: 'ЖК и застройщикам, ресторанам, автосалонам, локальному бизнесу, мероприятиям',
  ...
  },
  {
    ...
    fits: 'Кофейням, пекарням, аптекам, локальным акциям; мероприятиям, бизнесу с пешеходным трафиком',
  ...
  },
  {
    ...
    fits: 'Ресторанам и доставкам, мобильным приложениям, фитнесу, онлайн-сервисам, концертам и мероприятиям',
  ...
  },
  {
    ...
    fits: 'Премиум-сегменту, застройщикам, автосалонам, крупным мероприятиям, ресторанам в центре, имиджевым кампаниям',
  ...
  },
  {
    ...
    fits: 'ЖК, крупным ТЦ, автосалонам, государственным и городским проектам, масштабным мероприятиям',
  ...
  },
  {
    ...
    fits: 'Федеральным компаниям, девелоперам, банкам; крупным сетям, брендам с долгими рекламными кампаниями',
