      ...
      <section className="bg-[#0A0A0A] text-[#FBF8F3] pattern-dark hero-pad-top pb-16">
        <div className="pattern-content max-w-7xl mx-auto px-6">
          ...
          <p className="text-[#FBF8F3]/50 text-base max-w-2xl leading-relaxed mb-8">
            Личная рекомендация автора помогает сформировать доверие к бренду. Подбираем блогеров
            под вашу аудиторию и задачу, согласовываем формат и условия, контролируем выход
            интеграции и присылаем отчётность.
          </p>
          <div className="flex flex-wrap items-center gap-x-7 gap-y-2 mb-8">
            {[
