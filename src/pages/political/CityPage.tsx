...
import { PLATFORMS, SOCIALS, CASES, CITIES_INFO } from '@/data/political-data';
    ...
    <section className="bg-[#FBF8F3] py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#E8E2D8]">
          {([
            { name: 'Хабаровск', path: '/political/cities/khabarovsk', pop: '620 000+', desc: 'Столица Дальнего Востока' },
            { name: 'Владивосток', path: '/political/cities/vladivostok', pop: '600 000+', desc: 'Морские ворота России' },
            { name: 'Комсомольск-на-Амуре', path: '/political/cities/komsomolsk', pop: '240 000+', desc: 'Промышленный центр' },
          ]).map((city) => (
...
export default function CityPage() {
  ...
  if (!cityName) return (
    <div className="pt-28 text-center py-24">
      ...
      <Link to="/political/platforms" className="text-sm text-[#A21D27]">Вернуться в каталог</Link>
    </div>
  );
            ...
            <div>
              ...
              <div className="flex flex-col gap-px bg-[#E8E2D8] mb-8">
                {content.bestSocials.map((key) => {
                  ...
                  const paths: Record<string, string> = { vk: '/political/socials/vk', telegram: '/political/socials/telegram', ok: '/political/socials/ok', tiktok: '/political/socials/tiktok', max: '/political/socials/max' };
                  return (
        ...
        <section className="bg-[#F2EDE4] py-16 reveal">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link to="/political/platforms" className="text-xs text-[#0A0A0A] hover:text-[#A21D27] transition-colors flex items-center gap-1" style={{ letterSpacing: '0.1em' }}>
