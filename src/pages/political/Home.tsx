...
import { FAQ_DATA, WORK_STEPS } from '@/data/political-data';

const DIRECTIONS = [
  {
    num: '01',
    title: 'Городские сообщества',
    path: '/political/communities',
        ...
        <div className="pattern-content max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <Link to="/political/faq" className="btn-outline-dark">Все вопросы</Link>
            </div>
      ...
      <section id="cta" className="bg-[#0A0A0A] pattern-dark min-h-screen flex items-center reveal">
        <div className="pattern-content max-w-7xl mx-auto px-6 py-16 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <ContactForm dark source="Политическая — Главная" />
          </div>
        </div>
      </section>
    </div>
