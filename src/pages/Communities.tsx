      ...
      <section className="bg-[#0A0A0A] text-[#FBF8F3] pattern-dark hero-pad-top pb-16">
        <div className="pattern-content max-w-7xl mx-auto px-6">
          ...
          <p className="text-[#FBF8F3]/50 text-base max-w-2xl leading-relaxed mb-8">
            Размещения там, где жители каждый день читают новости, обсуждают события и ищут рекомендации.
            Подбираем сообщества под вашу задачу, согласовываем условия с владельцами площадок,
            ставим выходы в график и присылаем отчётность по каждому размещению.
          </p>
